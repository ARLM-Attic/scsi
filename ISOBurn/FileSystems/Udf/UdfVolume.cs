...
namespace FileSystems.Udf
{
	...
	public partial class UdfVolume : IDisposable
	{
		...
		protected virtual void Dispose(bool disposing)
		{
			if (disposing)
			{
				try
				{
					...
					if (this.BaseStream.CanWrite) { this.Flush(); }
				}
		...
		public AnchorVolumeDescriptorPointer GetAnchorVolumeDescriptorPointer() { return (AnchorVolumeDescriptorPointer)this.anchorVolumeDescriptorPointer.Clone(); }
