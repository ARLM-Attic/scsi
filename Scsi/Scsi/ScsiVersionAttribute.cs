...
namespace Scsi
{
	...
	public sealed class ScsiComplianceAttribute : Attribute
	{
		...
		{
			this.ComplyingStandard = complyingStandard;
	...
	public enum ScsiStandard { PrimaryCommands, ArchitecturalModel, BlockCommands, MultimediaCommands, StreamCommands, ParallelInterfaceCommands }
}