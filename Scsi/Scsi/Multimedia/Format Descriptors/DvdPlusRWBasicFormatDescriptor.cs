...
namespace Scsi.Multimedia
{
	...
	public class DvdPlusRWBasicFormatDescriptor : FormatDescriptorOther
	{
		...
		public DvdPlusRWBasicFormatDescriptor(uint formatMode) : this() { this.FormatMode = formatMode; }
		/// <summary>This should be zero to indicate a new format, or one to indicate a complete format.</summary>
		public uint FormatMode { get { return this.TypeDependentParameter; } set { this.TypeDependentParameter = value; } }
	}
}