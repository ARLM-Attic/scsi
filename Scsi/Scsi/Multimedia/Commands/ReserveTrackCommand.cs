...
namespace Scsi.Multimedia
{
	...
	public class ReserveTrackCommand : FixedLengthScsiCommand
	{
			...
			: this()
		{
			...
			this.LogicalTrackReservationParameter = new LogicalTrackReservationParameter(reservation, isLogicalBlockAddressInsteadOfReservationSize);
		}

		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte byte1;
		/// <summary>Should be zero for non-HD DVDs.</summary>
		public bool RMZ { get { return Bits.GetBit(this.byte1, 1); } set { this.byte1 = Bits.SetBit(this.byte1, 1, value); } }
		...
		[Description("When set to false, indicates that the LogicalTrackReservationParameter.ReservationSize property is set. When set to true, means that the LogicalTrackReservationParameter.ReservationLogicalBlockAddress property is set.")]
		public bool ARSV { get { return Bits.GetBit(this.byte1, 0); } set { this.byte1 = Bits.SetBit(this.byte1, 0, value); } }
