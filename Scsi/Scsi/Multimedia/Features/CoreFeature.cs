...
namespace Scsi.Multimedia
{
	...
	public class CoreFeature : MultimediaFeature
	{
		...
		private static readonly ScsiCommandCode[] __SupportedOperations = Sort(new ScsiCommandCode[] { ScsiCommandCode.GetConfiguration, ScsiCommandCode.GetEventStatusNotification, ScsiCommandCode.Inquiry, ScsiCommandCode.ModeSelect10, ScsiCommandCode.ModeSense10, ScsiCommandCode.RequestSense, ScsiCommandCode.TestUnitReady });
