...
namespace Scsi.Multimedia
{
	...
	public abstract class MultimediaFeature : IMarshalable
	{
		...
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private static readonly IntPtr FEATURE_CODE_OFFSET = Marshal.OffsetOf(typeof(MultimediaFeature), "_FeatureCode");
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private static readonly IntPtr ADDITIONAL_LENGTH_OFFSET = Marshal.OffsetOf(typeof(MultimediaFeature), "_AdditionalLength");
#if false
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private static IDictionary<MultimediaProfile, ReadOnlyCollection<FeatureCode>> __Profiles;
#endif
		protected MultimediaFeature(FeatureCode featureCode) : base() { this.FeatureCode = featureCode; }
		...
		public bool Current { get { return Bits.GetBit(this.byte2, 0); } protected set { this.byte2 = Bits.SetBit(this.byte2, 0, value); } }
		[DisplayName("Always Active")]
		public bool Persistent { get { return Bits.GetBit(this.byte2, 1); } protected set { this.byte2 = Bits.SetBit(this.byte2, 1, value); } }
		[DisplayName("Feature Version")]
		public byte Version
		{
			get { return Bits.GetValueMask(this.byte2, 2, VERSION_MASK); }
			protected set { this.byte2 = Bits.PutValueMask(this.byte2, value, 2, VERSION_MASK); }
		}
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		...
		{
			var defaultSize = Marshal.SizeOf(this);
		...
		internal static MultimediaFeature FromBuffer(BufferWithSize buffer) { FeatureCode code = MultimediaFeature.ReadFeatureCode(buffer); MultimediaFeature result = CreateInstance(code); if (result != null) { result.MarshalFrom(buffer); } return result; }
		...
		protected static T[] Sort<T>(T[] array) { Array.Sort(array); return array; }
	...
	public enum FeatureCode : short
	{
		...
		[EnumValueDisplayName("Removable Medium")]
		...
		[EnumValueDisplayName("Write Protect")]
		...
		[EnumValueDisplayName("Random Read")]
		...
		[EnumValueDisplayName("Multi-Read")]
		...
		[EnumValueDisplayName("Random Write")]
		...
		[EnumValueDisplayName("Incremental Streaming Write")]
		...
		[EnumValueDisplayName("Defect Management")]
		...
		[EnumValueDisplayName("Write-Once")]
		...
		[EnumValueDisplayName("Restricted Overwrite")]
		...
		[EnumValueDisplayName("CD-RW CAV Write")]
		...
		[EnumValueDisplayName("Mount Rainier Rewritable (MRW)")]
		...
		[EnumValueDisplayName("Enhanced Defect Reporting")]
		...
		[EnumValueDisplayName("Rigid Restricted Overwrite")]
		...
		[EnumValueDisplayName("CD Track-at-Once")]
		...
		[EnumValueDisplayName("CD Mastering (Session-at-once or RAW)")]
		...
		[EnumValueDisplayName("DVD-RW Write")]
		...
		/// <summary></summary>
		[EnumValueDisplayName("Double-Density CD (DDCD) Read")]
		DoubleDensityCDRead = 0x0030,
		/// <summary></summary>
		[EnumValueDisplayName("Double-Density CD-R (DDCD-R) Write")]
		DoubleDensityCDRWrite = 0x0031,
		/// <summary></summary>
		[EnumValueDisplayName("Double-Density CD-RW (DDCD-RW) Write")]
		...
		[EnumValueDisplayName("Layer Jump Recording")]
		...
		[EnumValueDisplayName("Layer Jump Rigid Restricted Overwrite")]
		...
		[EnumValueDisplayName("Stop Long Operation")]
		...
		[EnumValueDisplayName("CD-RW Write")]
		...
		[EnumValueDisplayName("BD Pseudo-Overwrite (BD-POW)")]
		...
		[EnumValueDisplayName("Timely Safe Recording")]
		...
		[EnumValueDisplayName("HD DVD Read")]
		...
		[EnumValueDisplayName("HD DVD Write")]
		...
		[EnumValueDisplayName("HD DVD-RW Fragment Recording")]
		...
		[EnumValueDisplayName("Hybrid Disc")]
		...
		[EnumValueDisplayName("Power Management")]
		...
		[EnumValueDisplayName("Self Monitoring Analysis and Reporting Technology (SMART)")]
		...
		[EnumValueDisplayName("Embedded Changer")]
		...
		/// <summary></summary>
		[EnumValueDisplayName("CD Audio External Play")]
		...
		[EnumValueDisplayName("Microcode Upgrade")]
		...
		[EnumValueDisplayName("DVD Content Scrambling System (CSS)")]
		[Description("This feature identifies a drive that is able to perform DVD CSS/CPPM authentication and key management. This feature identifies drives that support CSS for DVD-Video and CPPM for DVD-Audio. The drive maintains the integrity of the keys by only using DVD CSS authentication and key management procedures. This feature is current only if a media containing CSS-protected DVD-Video and/or CPPM-protected DVDAudio content is loaded.")]
		...
		[EnumValueDisplayName("Realtime Streaming")]
		...
		[EnumValueDisplayName("Drive Serial Number")]
		...
		[EnumValueDisplayName("Media Serial Number")]
		...
		[EnumValueDisplayName("Disc Control Blocks")]
		...
		[EnumValueDisplayName("DVD Content Protection for Recordable Media (CCPM)")]
		...
		[EnumValueDisplayName("Firmware Information")]
		...
		[EnumValueDisplayName("Advanced Access Content System (AACS)")]
		...
		[EnumValueDisplayName("DVD Content Scrambling System (CSS) Managed Recording")]
		...
		[EnumValueDisplayName("SecurDisc")]
