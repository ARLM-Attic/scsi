...
namespace Scsi.Multimedia
{
	...
	[Description("This feature identifies a drive that has the ability to write CD-RW media that is designed for constant angular velocity recording.\r\nThe drive conforms to the Orange Book Part 3 Volume 2 specification.\r\nThis feature is not current if high-speed recordable CD-RW media is not mounted.")]
	[StructLayout(LayoutKind.Sequential, Pack = 1)]
	public class CDRWConstantAngularVelocityWriteFeature : MultimediaFeature
	{
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private static readonly ScsiCommandCode[] __SupportedOperations = Sort(new ScsiCommandCode[] { ScsiCommandCode.ReadCapacity, ScsiCommandCode.ReadDiscInformation, ScsiCommandCode.ReadTrackInformation, ScsiCommandCode.SynchronizeCache10, ScsiCommandCode.Write10 });
