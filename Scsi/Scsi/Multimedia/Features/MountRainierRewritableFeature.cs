...
namespace Scsi.Multimedia
{
	...
	public class MountRainierRewritableFeature : MultimediaFeature
	{
		...
		public bool CDWrite { get { return Bits.GetBit(this.byte4, 0); } set { this.byte4 = Bits.SetBit(this.byte4, 0, value); } }
		[DisplayName("Read DVD+MRW")]
		public bool DvdPlusRead { get { return Bits.GetBit(this.byte4, 1); } set { this.byte4 = Bits.SetBit(this.byte4, 1, value); } }
		[DisplayName("Format and Write DVD+MRW")]
		public bool DvdPlusWrite { get { return Bits.GetBit(this.byte4, 2); } set { this.byte4 = Bits.SetBit(this.byte4, 2, value); } }
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte byte5;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte byte6;
