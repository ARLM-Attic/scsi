...
namespace Scsi.Multimedia
{
	...
	public class FormattableFeature : MultimediaFeature
	{
		...
		private static readonly ScsiCommandCode[] __SupportedOperations = Sort(new ScsiCommandCode[] { ScsiCommandCode.Format, ScsiCommandCode.ReadFormatCapacities, ScsiCommandCode.RequestSense, ScsiCommandCode.Verify10 });
