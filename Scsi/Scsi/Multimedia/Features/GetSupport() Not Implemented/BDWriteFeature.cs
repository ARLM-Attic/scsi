...
namespace Scsi.Multimedia
{
	...
	public class BDWriteFeature : MultimediaFeature
	{
		...
		private static readonly ScsiCommandCode[] __SupportedOperations = Sort(new ScsiCommandCode[] { ScsiCommandCode.Format, ScsiCommandCode.Write10 });
		...
		private short[] _BDREWriteSupportBitmap = new short[4];
		public short[] BDREWriteSupportBitmap { get { return this._BDREWriteSupportBitmap; } }
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		[MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
		private short[] _BDRWriteSupportBitmap = new short[8];
		public short[] BDRWriteSupportBitmap { get { return this._BDRWriteSupportBitmap; } }
