...
namespace Scsi.Multimedia
{
	...
	[Description("This feature identifies a drive that has the ability to perform writing CD-RW media.\r\nThis feature is not current if CD-RW media is not mounted.")]
	...
	public class CDRWMediaWriteSupportFeature : MultimediaFeature
	{
		...
		private byte byte4;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte _MediaSubtypeSupport;
		[DisplayName("Media Sub-type Support")]
		public byte MediaSubtypeSupport { get { return this._MediaSubtypeSupport; } set { this._MediaSubtypeSupport = value; } }
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte byte6;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte byte7;
