...
namespace Scsi.Multimedia
{
	...
	public class PowerManagementFeature : MultimediaFeature
	{
		...
		private static readonly ScsiCommandCode[] __SupportedOperations = Sort(new ScsiCommandCode[] { ScsiCommandCode.GetEventStatusNotification, ScsiCommandCode.StartStopUnit });
