...
namespace Scsi.Multimedia
{
	...
	public class RigidRestrictedOverwriteFeature : MultimediaFeature
	{
		...
		public bool DefectStatusDataGenerate { get { return Bits.GetBit(this.byte4, 3); } set { this.byte4 = Bits.SetBit(this.byte4, 3, value); } }
		[DisplayName("Read Defect Status Data")]
		public bool DefectStatusDataRead { get { return Bits.GetBit(this.byte4, 2); } set { this.byte4 = Bits.SetBit(this.byte4, 2, value); } }
