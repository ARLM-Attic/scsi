...
namespace Scsi.Multimedia
{
	...
	public class HDDvdRWFragmentRecordingFeature : MultimediaFeature
	{
		...
		public bool BackgroundPadding { get { return Bits.GetBit(this.byte4, 0); } set { this.byte4 = Bits.SetBit(this.byte4, 0, value); } }
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte byte5;
		[DebuggerBrowsable(DebuggerBrowsableState.Never)]
		private byte byte6;
