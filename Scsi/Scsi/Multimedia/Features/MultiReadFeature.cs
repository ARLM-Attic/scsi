...
namespace Scsi.Multimedia
{
	...
	public class MultiReadFeature : MultimediaFeature
	{
		...
		private static readonly ScsiCommandCode[] __SupportedOperations = Sort(new ScsiCommandCode[] { ScsiCommandCode.Read10, ScsiCommandCode.ReadCD, ScsiCommandCode.ReadDiscInformation, ScsiCommandCode.ReadTrackInformation });
