...
namespace Scsi.Multimedia
{
	...
	{
		private MultimediaDevice device;
		...
		public TrackStream(MultimediaDevice device, ushort trackNumber, long startPos, long length, long maxLength, bool leaveOpen)
		...
		public MultimediaDevice Device { get { return this.device; } }
		...
		public override long Seek(long offset, SeekOrigin origin) { var pos = base.Seek(offset, origin); this.Device.Seek10(new Seek10Command((uint)((pos + this.BaseStartPosition) / this.Device.BlockSize))); return pos; }
