	...
	public static class VendorIdentifiers
	{
		public static string GetVendorName(string vendorId)
		{
			...
			switch (vendorId)
			{
				...
				case "ANDATACO": return "Andataco  (now nStor)";
				...
				case "ARISTOS": return "Aristos Logic Corp. (now part of Adaptec)";
				case "ARK": return "ARK Research Corporation";
				case "ARTECON": return "Artecon Inc.  (Obs. - now Dot Hill)";
				...
				case "BiT": return "BiT Microsystems (obsolete, new ID: BITMICRO)";
				...
				case "BoxHill": return "Box Hill Systems Corporation  (Obs. - now Dot Hill)";
				...
				case "COMPAQ": return "Compaq Computer Corporation (now HP)";
				...
				case "CROSFLD": return "Crosfield Electronics (now FujiFilm Electonic Imaging Ltd)";
				...
				case "DEC": return "Digital Equipment Corporation (now HP)";
				case "DEI": return "Digital Engineering, Inc.";
				case "DELL": return "Dell Computer Corporation";
				...
				case "Digital": return "Digital Equipment Corporation (now HP)";
				...
				case "EuroLogc": return "Eurologic Systems Limited (now part of Adaptec)";
				...
				case "Gadzoox": return "Gadzoox Networks, Inc. (now part of Broadcom)";
				...
				case "LEFTHAND": return "LeftHand Networks (now HP)";
				...
				case "Malakite": return "Malachite Technologies";
				...
				case "NCITS": return "InterNational Committee for Information Technology Standards";
				...
				case "SIMPLE": return "SimpleTech, Inc. (Obs - now STEC, Inc.)";
				...
				case "SPERRY": return "Sperry (now Unisys Corp.)";
				...
				case "STORAPP": return "StorageApps, Inc. (now HP)";
				...
				case "TANDEM": return "Tandem (now HP)";
				...
				case "Test": return "Test new Vendor ID software - delete me!";
				...
				case "VIXEL": return "Vixel Corporation (now part of Emulex)";
				...
				case "WD": return "Western Digital Technologies Inc.";
				case "WDC": return "Western Digital Technologies inc.";
				case "WDIGTL": return "Western Digital";
				case "WEARNES": return "Wearnes Technology Corporation";
				case "WSC0001": return "Wisecom, Inc.";
				case "X3": return "International Committee for Information Technology Standards)";
