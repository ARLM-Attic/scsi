...
namespace Scsi
{
	...
	public abstract class VitalProductDataInquiryData : InquiryData
	{
		...
		public byte PageLength { get { return Bits.BigEndian(this._PageLength); } protected set { this._PageLength = Bits.BigEndian(value); } }

		internal static byte ReadPageLength(BufferWithSize buffer) { return buffer.Read<byte>(PAGE_LENGTH_OFFSET); }
	}
